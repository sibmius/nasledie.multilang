...
class nasledie_multilang extends CModule {

	var $MODULE_ID = "nasledie.multilang";
	...
	private $arModuleDependences = array(
		array('main', 'OnBuildGlobalMenu', 'nasledie.multilang', '\Nasledie\MultiLang\Handler', 'main_onBuildGlobalMenu'),
	);
	...
	public function __construct() {
		...
		$this->MODULE_NAME = Loc::getMessage('nasledie_multilang_MODULE_NAME');
		$this->MODULE_DESCRIPTION = Loc::getMessage('nasledie_multilang_MODULE_DESCRIPTION');
		$this->PARTNER_NAME = GetMessage('nasledie_multilang_PARTNER_NAME');
		$this->PARTNER_URI = GetMessage('nasledie_multilang_PARTNER_URI');
